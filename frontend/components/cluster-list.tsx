            ...
            {cluster.featureImage && (
              <div className="relative w-full h-auto">
                ...
                <div className="absolute inset-0 bg-black/10 flex flex-col justify-end p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <CardTitle className="text-white text-lg">{cluster.imageCount} images</CardTitle>
                  <CardDescription className="text-gray-200 text-sm"> ({cluster.startYear} - {cluster.endYear})</CardDescription>
                </div>
              </div>
            )}
          </Card>
