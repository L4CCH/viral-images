...
export function ImageClusters({ startYear, endYear, imageClusters, currentCluster }: ImageClustersProps) {
  ...
  const filteredImages = useMemo(() => {
    ...
    let images = currentCluster.similarImages;
  ...
  if (!imageClusters || !currentCluster) {
    return <div className="text-center py-4">No data available or image not found.</div>;
  }
      ...
      {filteredImages.length > 0 && (
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            ...
            {filteredImages.length} reprints ({startYear}-{endYear})
          </Badge>
              ...
              {selectedImage && (
                <div className="space-y-4 border-t pt-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <div className="relative overflow-hidden rounded-lg border flex items-center justify-center max-h-[300px]">
                        <Image
